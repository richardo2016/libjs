...
export const vuexLikeConnect = function (options) {
  ...
  let orig_mergeStateToProps = (state, ownProps) => {
    let computedState = {},
        $state = {
          ...state,
          ...$store.getState()
  ...
  let orig_mergeDispatchToProps = (dispatch, ownProps) => {
  ...
  let orig_mergeProps = (stateProps, dispatchProps, ownProps) => {
    let mergedProps =
  ...
  return origConnect(
    orig_mergeStateToProps,
    orig_mergeDispatchToProps,
    orig_mergeProps,
    {
      withRef,
      pure
