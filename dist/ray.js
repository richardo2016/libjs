...
exports.generate = __webpack_require__(6);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__node_object_js__ = __webpack_require__(8);
...
exports.iterator = __webpack_require__(3);
exports.flux = __webpack_require__(2);
exports.webpack = __webpack_require__(9);
exports.string = __webpack_require__(5);
exports.logger = __webpack_require__(10);

exports.utils = {
  listpagination: __webpack_require__(12)
};
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "computeListPagiParams", function() { return computeListPagiParams; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "computeListPagination", function() { return computeListPagination; });
/* harmony export (immutable) */ __webpack_exports__["paginationToQuery"] = paginationToQuery;
var computeListPagiParams = function computeListPagiParams() {
  var cuaPage = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
  var pageSize = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 20;

  var offset = cuaPage * pageSize,
      size = pageSize;
...
var computeListPagination = function computeListPagination(total) {
  ...
  pagination.canPrevEtc = function (_ref) {
    var _ref$navCount = _ref.navCount,
        navCount = _ref$navCount === undefined ? 1 : _ref$navCount,
        _ref$firstNav = _ref.firstNav,
        firstNav = _ref$firstNav === undefined ? pagination.firstPage : _ref$firstNav;

    var half = parseInt(navCount / 2),
  ...
  pagination.canNextEtc = function (_ref2) {
    var _ref2$navCount = _ref2.navCount,
        navCount = _ref2$navCount === undefined ? 1 : _ref2$navCount,
        _ref2$lastNav = _ref2.lastNav,
        lastNav = _ref2$lastNav === undefined ? pagination.lastPage : _ref2$lastNav;
  ...
  pagination.genIndicators = function (options) {
    ...
    var _ref3 = options || {},
        _ref3$navCount = _ref3.navCount,
        navCount = _ref3$navCount === undefined ? 1 : _ref3$navCount,
        _ref3$pageLen = _ref3.pageLen,
        pageLen = _ref3$pageLen === undefined ? pagination.len : _ref3$pageLen,
        _ref3$start = _ref3.start,
        start = _ref3$start === undefined ? pagination.curPage - parseInt(navCount / 2) : _ref3$start;

    var len = Math.min(navCount, pageLen);

    if (start < pagination.firstPage) start = pagination.firstPage;else if (start + len > pagination.lastPage) start = pagination.lastPage - len + 1;
...
function paginationToQuery(pagination) {
  var _ref4 = pagination || {},
      _ref4$curPage = _ref4.curPage,
      curPage = _ref4$curPage === undefined ? 0 : _ref4$curPage,
